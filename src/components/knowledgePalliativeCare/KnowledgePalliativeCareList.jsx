...
import KnowledgePalliativeCare from "./KnowledgePalliativeCare";

const Container = styled.div`
  ${PageSytles}
`;

const KnowledgePalliativeCareList = () => {
      ...
      <div>
        <div className="top">
          <div style={{ marginTop: "20px" }} >
            <span className="logs" style={{ fontWeight: "bold", marginLeft: "20px" }}>Improved skills and knowledge of palliative care research in Africa</span>
          </div>
              ...
              <table className="table table-striped table-bordered">
                <thead style={{ textAlign: "center", fontSize: "12px" }}>
                  <tr>
                    <th>No.</th>
                    <th>FYPeriod</th>
                    <th>Knowledge Palliative Care</th>
                    <th>APR-JUN</th>
                    <th>JUL-SEP</th>
                    <th>OCT-DEC</th>
                    <th>JAN-MAR</th>
...
export default KnowledgePalliativeCareList;

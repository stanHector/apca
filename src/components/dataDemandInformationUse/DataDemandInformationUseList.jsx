...
import DataDemandInformationUse from "./DataDemandInformationUse";
const Container = styled.div`
  ${PageSytles}
`;

const DataDemandInformationUseList = () => {
            ...
            <div>
                <div className="top">
                    <div style={{ marginTop: "20px" }} >
                        <span className="logs" style={{ fontWeight: "bold", marginLeft: "20px" }}>Data demand and information use</span>
                    </div>
...
export default DataDemandInformationUseList;

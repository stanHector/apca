                                ...
                                <div className="container">
                                    <form>
                                        <div className="controls">
                                            ...
                                            <div className="col-sd-12">
                                                <div className="form-group">
                                                    <label style={{ fontWeight: "bold" }}>A functional web based PC clearing house</label>
                                                    <select name="need" className="form-control" required="required" data-error="">
                                                        <option value="" selected disabled>--Select web based PC clearing house--</option>
                                                        <option>Number of researchers/resource persons listed in database</option>
                                                        <option>Number of palliative care research resources developed</option>
                                                        <option>Number of palliative care research resources disseminated</option>
                                                        <option>Number of modules developed under palliative care</option>
...
export default WebBasePccLearningHouse;

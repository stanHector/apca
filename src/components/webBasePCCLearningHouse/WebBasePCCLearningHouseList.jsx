...
import WebBasePCCLearningHouse from "./WebBasePCCLearningHouse"

const Container = styled.div`
  ${PageSytles}
`;

const WebBasePCCLearningHouseList = () => {
  const [showWebForm, setShowWebForm] = useState(false);

  const toggleForm = () => {
    setShowWebForm(!showWebForm);
  }
      ...
      <div>
        <div className="top">
          <div style={{ marginTop: "20px" }} >
            <span className="logs" style={{ fontWeight: "bold", marginLeft: "20px" }}>A functional web based PC clearing house</span>
          </div>
              ...
              <table className="table table-striped table-bordered">
                <thead style={{ textAlign: "center", fontSize: "12px" }}>
                  <tr>
                    <th>No.</th>
                    <th>FYPeriod</th>
                    <th>Web based PC clearing house</th>
                    <th>APR-JUN</th>
                    <th>JUL-SEP</th>
                    <th>OCT-DEC</th>
                    <th>JAN-MAR</th>
...
export default WebBasePCCLearningHouseList;
